...
<body>
    ...
    <main>
        ...
        <?php //print_r($custom_fields['invoice']['intro']); 
        ?>
        <table class="item-table">
            <thead>
                <tr>
                    <th class="item-name"><?php _trans('Bezeichnung'); ?></th>
                    <!--<th class="item-desc"><?php _trans('description'); ?></th>-->
                    <th class="item-price text-right">Gesamtkosten</th>
                    <th class="item-amount text-right">Umschlagschlüssel</th>
                    <th class="item-amount text-right">Anteilschlüssel</th>
                    <th class="item-total text-right"><?php _trans('Anteilkosten'); ?></th>
                </tr>
            </thead>
            <tbody>
            ...
            <tbody class="invoice-sums">
                ...
                <?php if ($invoice->invoice_discount_percent != '0.00') : ?>
                    <tr>
                        <td <?php echo ($show_item_discounts ? 'colspan="5"' : 'colspan="3"'); ?> class="text-right">
                            <?php _trans('discount'); ?>
                        </td>
                        <td class="text-right">
